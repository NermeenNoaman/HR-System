...
namespace HRSystem_Wizer_.Controllers
{
    ...
    {
        private readonly IGenericRepository<LkpBenefitType> _repository;
        private readonly IMapper _mapper;

        public BenefitTypeController(IGenericRepository<LkpBenefitType> repository, IMapper mapper)
        {
        ...
        public async Task<IActionResult> GetAll()
        {
            try
            {
                ...
                var dtos = _mapper.Map<IEnumerable<BenefitTypeReadDto>>(entities);
                return Ok(dtos);
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> GetById(int id)
        {
            try
            {
                ...
                var dto = _mapper.Map<BenefitTypeReadDto>(entity);
                return Ok(dto);
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> Create([FromBody] BenefitTypeCreateDto dto)
        {
            try
            {
                ...
                var createdDto = _mapper.Map<BenefitTypeReadDto>(createdEntity);
