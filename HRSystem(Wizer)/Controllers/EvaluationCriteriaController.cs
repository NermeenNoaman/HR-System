...
namespace HRSystem_Wizer_.Controllers
{
    ...
    public class EvaluationCriteriaController : ControllerBase
    {
        ...
        public EvaluationCriteriaController(IGenericRepository<TPLEvaluationCriterion> repository, IMapper mapper)
        {
        ...
        public async Task<IActionResult> GetAll()
        {
            try
            {
                ...
                var dtos = _mapper.Map<IEnumerable<EvaluationCriteriaReadDto>>(entities);
                return Ok(dtos);
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> GetById(int id)
        {
            try
            {
                ...
                var dto = _mapper.Map<EvaluationCriteriaReadDto>(entity);
                return Ok(dto);
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> Create([FromBody] EvaluationCriteriaCreateDto dto)
        {
            try
            {
                ...
                var createdDto = _mapper.Map<EvaluationCriteriaReadDto>(createdEntity);
